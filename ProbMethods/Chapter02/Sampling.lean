...
/-- **Lemma 2.4.3 (the base case).** On five vertices a tetrahedron-free 3-graph has at most
`7` of the `10` triples — the base case of Proposition 2.4.4, and exactly tight.
