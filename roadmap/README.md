...
| 10 | 10 Entropy | [entropy.md](entropy.md) | **§10.1, §10.2, §10.4**: Thms 10.4.1/10.4.3/10.4.5/**10.4.9**, Cors 10.4.6/10.4.7, and **Thm 10.2.1 (Brégman–Minc)**; **Thm 10.3.3 (Blakey–Roy)**; §10.2's Cor 10.2.2 general case, §10.3's remaining cases open |
