...
| 9 | 9 Concentration of Measure | [mathlib-survey.md](mathlib-survey.md) | **§9.1 proved here** (Thm 9.1.1/9.1.3 + coupon collector) and **§9.3's Thm 9.3.1** (Shamir–Spencer), both modulo task #47; §9.2 upstream (Azuma–Hoeffding); **§9.4's cube isoperimetry started**: ball expansion and the Chernoff estimate proved, Thm 9.4.5 proved conditional on Harper (published as a task); §9.5 Talagrand absent |
